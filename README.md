...
!) Если в заначке тоже были изменения:
Произойдёт конфликт, если в одном файле в одной строке были изменения.
В терминале появится что-то вроде сообщения: `CONFLICT (content): Merge conflict in <файл> The stash entry was kept in case you need it again.`
Через VS Code:
